= Contents =
    - [[#receipts|receipts]]
        - [[#receipts#downgrade package|downgrade package]]
        - [[#receipts#prevent package from upgrading|prevent package from upgrading]]
        - [[#receipts#multi-user system|multi-user system]]
        - [[#receipts#show dependency tree|show dependency tree]]
