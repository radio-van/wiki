## Contents =
    ...
    - [[#usage|usage]]
        - [[#usage#add new password|add new password]]
        - [[#usage#generate new password|generate new password]]
        - [[#usage#retrieve password|retrieve password]]
...
`pass init <gpg key id>` assume [[gnupg#Contents|gnupg]] key pair is configured
