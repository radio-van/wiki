...
- [usage](#usage)
    - [branch](#usage#branch)
        - [change base](#usage#branch#change base)
    ...
    - [rename branch](#usage#rename branch)
        - [set upstream](#usage#rename branch#set upstream)
        - [show graph](#usage#rename branch#show graph)
