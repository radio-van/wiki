## Contents =
    ...
    - [[#Containers|Containers]]
        - [[#Containers#recreate container|recreate container]]
        - [[#Containers#removing container|removing container]]
        - [[#Containers#stop all containers|stop all containers]]
        - [[#Containers#rm all containers|rm all containers]]
    - [[#Managing|Managing]]
        - [[#Managing#unused stuff|unused stuff]]
        - [[#Managing#location|location]]
